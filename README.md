...
To evaluate the proposed decision models, we conducted semi-structured interviews with 16 quantum software practitioners from eight countries. Participants were selected through GitHub, professional platforms (e.g., LinkedIn, Facebook), and personal networks. Prior to the interviews, each participant received a standardized [interview questionnaire](https://tinyurl.com/bdcvzjjb) and a supplementary document containing [architectural pattern examples](https://tinyurl.com/2fwcbkmh). The interview guide, structured into seven sections, was designed to evaluate six decision models across key design areas and to collect both quantitative and qualitative feedback. Inclusion and exclusion criteria were applied to ensure the quality and relevance of responses. All interviews were transcribed, coded, and analyzed using descriptive statistics and grounded theory methods.
